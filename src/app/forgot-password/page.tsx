      ...
      <div className="card" style={{ maxWidth: '400px', width: '100%', textAlign: 'center' }}>
        <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '1.5rem' }}>
          <div style={{ backgroundColor: 'var(--c-primary-container)', padding: '1rem', borderRadius: '50%' }}>
            <MailQuestion size={32} color="var(--c-on-primary-container)" />
          </div>
        </div>
        <h2 className="text-headline-md" style={{ marginBottom: '0.5rem' }}>Forgot Password</h2>
        <p className="text-body-md text-on-surface-variant" style={{ marginBottom: '2rem' }}>Enter your email to receive a reset link</p>
        ...
        {success ? (
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <p className="text-body-sm text-on-surface-variant" style={{ marginTop: '16px' }}>
              Remember your password? <Link href="/login" style={{ color: 'var(--c-primary)', fontWeight: 600, textDecoration: 'none' }}>Sign In</Link>
            </p>
          </form>
        )}
      </div>
