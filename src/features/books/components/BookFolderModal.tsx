...
import { addBookFolder, renameBookFolder } from '@/features/books/actions';
import { useToast } from '@/context/ToastContext';

interface Props {
  isOpen: boolean;
  onClose: () => void;
  editingFolder: BookFolder | null;
}

export default function BookFolderModal({ isOpen, onClose, editingFolder }: Props) {
