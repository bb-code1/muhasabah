...
import { addDocumentFolder, renameDocumentFolder } from '@/features/documents/actions';
...
export default function DocumentFolderModal({ isOpen, onClose, editingFolder }: Props) {
